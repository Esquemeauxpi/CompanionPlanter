        ...
        Entry(
            ...
            companions = listOf(
                Companion("Basil", "Repels aphids and hornworms; said to improve flavor.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Basil-Basilico-Ocimum_basilicum-albahaca.jpg/400px-Basil-Basilico-Ocimum_basilicum-albahaca.jpg",
                ...
                Companion("Marigold", "Deters nematodes and whiteflies from the root zone.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Marigold_or_Tagetes_erecta.jpg/400px-Marigold_or_Tagetes_erecta.jpg",
                ...
                Companion("Borage", "Attracts pollinators and deters tomato hornworm.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Borage_flower.jpg/400px-Borage_flower.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Carrot", "Loosens soil around pepper roots and fills ground space.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Carrots_with_stems.jpg/400px-Carrots_with_stems.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Onion", "Masks carrot scent, confusing the carrot fly.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Onion_on_White.JPG/400px-Onion_on_White.JPG",
                ...
                Companion("Rosemary", "Aromatic foliage deters the carrot fly.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Rosmarinus_officinalis_133575799.jpg/400px-Rosmarinus_officinalis_133575799.jpg",
                ...
                Companion("Chives", "Improves growth and helps repel aphids.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Chives_inflorescence.jpg/400px-Chives_inflorescence.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Nasturtium", "Trap crop for aphids; repels cucumber beetles.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Tropaeolum_majus_2.jpg/400px-Tropaeolum_majus_2.jpg",
                ...
                Companion("Dill", "Attracts predatory insects that hunt pests.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Anethum_graveolens_flowers.jpg/400px-Anethum_graveolens_flowers.jpg",
                ...
                Companion("Sunflower", "Provides a natural trellis and draws pollinators.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Sunflower_sky_backdrop.jpg/400px-Sunflower_sky_backdrop.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Mint", "Deters aphids and improves overall pea plant health.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Mentha_spicata_var._crispa.jpg/400px-Mentha_spicata_var._crispa.jpg",
                ...
                Companion("Radish", "Deters aphids and loosens soil for pea roots.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Radishes.jpg/400px-Radishes.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Chervil", "Light shade partner that deters aphids and slugs.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Anthriscus_cerefolium_001.JPG/400px-Anthriscus_cerefolium_001.JPG",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Chamomile", "Attracts beneficial insects and improves broccoli flavor.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Chamomile%40original_size.jpg/400px-Chamomile%40original_size.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Tomato", "Deters spider mites and other tomato pests.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Salad_garden.jpg/400px-Salad_garden.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Lettuce", "Uses space efficiently and keeps beet soil moist.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Salad_garden.jpg/400px-Salad_garden.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Tarragon", "Broadly improves growth of most vegetables including eggplant.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Estragon.jpg/400px-Estragon.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Bean", "The Three Sisters classic — beans fix nitrogen for corn.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Hopniss.jpg/400px-Hopniss.jpg",
                ...
                Companion("Squash", "Large leaves shade soil, retain moisture and deter weeds.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Squash_and_pumpkins.jpg/400px-Squash_and_pumpkins.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Corn", "Provides wind protection and shade for pumpkin roots.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Sweet_corn_closeup.jpg/400px-Sweet_corn_closeup.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Horseradish", "Deters Colorado potato beetles effectively.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Horseradish_plant.jpg/400px-Horseradish_plant.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Pepper", "Basil deters aphids and spider mites from pepper plants.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Bell_pepper_and_cross_section.jpg/400px-Bell_pepper_and_cross_section.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Brassicas", "Deters cabbage moth, aphids and flea beetles.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Broccoli_bunches.jpg/400px-Broccoli_bunches.jpg",
                ...
                Companion("Pea", "Mint deters aphids that commonly attack pea plants.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Peas_in_pods_-_Studio.jpg/400px-Peas_in_pods_-_Studio.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Sage", "Rosemary and sage are mutually beneficial and repel shared pests.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Salvia_officinalis_%28Sage%29.jpg/400px-Salvia_officinalis_%28Sage%29.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                Companion("Cucumber", "Dill attracts predatory insects that control cucumber pests.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Cucumber_on_white.jpg/400px-Cucumber_on_white.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Asparagus", "Parsley and asparagus are beneficial to each other.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Asparagus_officinalis1.jpg/400px-Asparagus_officinalis1.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Eggplant", "Thyme repels the flea beetles that target eggplant.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Aubergine.jpg/400px-Aubergine.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Echinacea", "Both attract pollinators and create a stunning display together.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Echinacea_purpurea.jpg/400px-Echinacea_purpurea.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Garlic", "Wards off aphids, blackspot and many beetles.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Garlic.jpg/400px-Garlic.jpg",
                ...
                Companion("Catmint", "Long-blooming filler that deters several pests.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Nepeta_cataria_-_harilik_kassinaeris.jpg/400px-Nepeta_cataria_-_harilik_kassinaeris.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Black-eyed Susan", "Long blooming seasons complement each other perfectly.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Rudbeckia_hirta.jpg/400px-Rudbeckia_hirta.jpg",
                ...
                Companion("Lemon Balm", "Both attract beneficial insects and look beautiful together.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Melissa_officinalis_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-097.jpg/400px-Melissa_officinalis_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-097.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Iris", "Irises and peonies bloom in sequence extending the display.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Iris_germanica_%28Purple_bearded_Iris%29%2C_Wakehurst_Place%2C_UK_-_Diliff.jpg/400px-Iris_germanica_%28Purple_bearded_Iris%29%2C_Wakehurst_Place%2C_UK_-_Diliff.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Cosmos", "Attracts beneficial insects and provides a long blooming season.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Cosmos_bipinnatus_-_Cosmea_-_panoramio_%283%29.jpg/400px-Cosmos_bipinnatus_-_Cosmea_-_panoramio_%283%29.jpg",
                ...
                Companion("Zinnia", "Zinnias attract hoverflies that eat aphids on dahlias.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Zinnia_elegans_flowers.jpg/400px-Zinnia_elegans_flowers.jpg",
        ...
        Entry(
            ...
            companions = listOf(
                ...
                Companion("Thyme", "Deters worms and boosts strawberry plant health.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Thymus_vulgaris_-_thyme.jpg/400px-Thymus_vulgaris_-_thyme.jpg",
                    "Full sun", "Low", "Use thyme as a fragrant ground cover around strawberry plants."),
                Companion("Spinach", "Spinach shades the soil and keeps strawberry roots cool.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Spinach_leaves.jpg/400px-Spinach_leaves.jpg",
                    "Partial shade", "Moderate", "Interplant spinach between strawberry crowns in spring.")
            ),
            badNeighbors = listOf(
